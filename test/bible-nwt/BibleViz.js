var BibleViz = new function(){
	...
	this.initialize = function(){
		...
		this.from = $("<div>John 17:1</div>").appendTo(this.verseData);
		$(this.from).css('position','absolute');
		$(this.from).css('left','100px');
		this.to = $("<div>John 17:26</div>").appendTo(this.verseData);
		$(this.to).css('position','absolute');
		$(this.to).css('right','150px');
		this.copyrightInfo = $("<div></div>");
		$(this.copyrightInfo).css('text-align','left');
		$("<hr><div style='margin-top:20px;'>NWT: New World Translation, Copyright &copy; 1961, 1984, 2013, 2018 by the Watchtower Society</div>").appendTo(this.copyrightInfo);
		$("<div style='margin-top:20px;'>ESV: English Standard Version, Copyright &copy; 2016</div>").appendTo(this.copyrightInfo);
